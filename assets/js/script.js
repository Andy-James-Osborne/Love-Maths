...
function runGame(gameType) {
    ...
    if (gameType === "addition") {
        ...
        throw `Unknown game type: ${gameType}. Exit Game!`;
    }
}

/**
 * Checks the answer against the first element in
 * the return correct answer array
 */
function checkAnswer() {
    ...
    if (isCorrect) {
        ...
        alert(`Aww... you answerws ${userAnswer}. the correct answer was ${calculatedAnswer[0]}!`);
...
/**
 * Gets the correct score from the dom
 */
